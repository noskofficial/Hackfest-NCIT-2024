...
import ncit from "./Assets/sponsorsLogos/NCIT_LOGO.jpg";
import nosk from "./Assets/sponsorsLogos/NOSK_Logo.png";
...
const TOP_SECTION = {
  ...
  IMG_SRC: boy,
  DISCORD_LINK: "",
  JUDGES_FORM_LINK: "https://nosk.org.np/",
  HACKERS_REGISTRATION_FORM_LINK: "https://nosk.org.np/",
};
...
const Prizeinfo = [
  ...
  [
    ...
    },
    {
      ...
      content:
        "Must use Open Source Tools in your project to win this category",
    },
  ],
  [
    //Array 3
  ...
  [
    [
      ...
      },
      {
        ...
        content: "Hackfest NCIT is open to only NCIT students.",
      },
      {
